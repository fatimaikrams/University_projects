...
#tweetCriteria = got.manager.TweetCriteria().setQuerySearch("#coronavirus").setUsername("dawn_com").setTopTweets(True).setSince(
 #   "2019-11-01")
...
print("number of positive of tweets news house 1",tweetPCount1)  
...
print("Analysis for News House 2:")
...
plt.show()
# Data to plot2
print("Analysis for News House 1:")
...
#print(dif)
if(percent_positive>percent_neutral  and  dif>=10 and percent_positive+percent_negative>=50):
    print("new house 1 spread more  positivity towards corona virus")
elif(percent_negative>percent_neutral  and dif<0 and dif<=(-10) and percent_positive+percent_negative>=50):
    print("news house 1 spreads more thrill towards corona virus")
elif(percent_neutral>=50):
    print("news house1 nuetral news towards corona virus")
else:
    print("news house 1 nuetral news towards corona virus")
dif1=percent_positive1-percent_negative1
#print(dif1)

if(dif1>=10 and  percent_positive1+percent_negative1>=50):
    print("this news house 2 spread more  positivity towards corona virus")
elif(dif1<0 and dif1<=(-10) and  percent_positive1+percent_negative1>=50):
    print("news house 2 spread more thrill towards corona virus")
else:
    print("news house 2 spread nuetral news towards corona virus")
...
chart1.set_title({'name': 'Analysis for News House BBC:'}) 
chart1.set_style(10) 
...
chart2.add_series({ 
	'name':	 'News House DAWN', 
	'categories': ['Sheet1', 18, 0, 20, 0], 
	'values':	 ['Sheet1', 18, 1, 20, 1], 
}) 
chart2.set_title({'name': 'Analysis for News House DAWN:'}) 
chart2.set_style(10) 
